...
#' # cure rate for a subgroup population with age as the mean and female
#' estcure(object=result,z_value=c(0,1))
#' # cure rate for a subgroup population with 20 years younger than the mean age and male
#' estcure(object=result,z_value=c(-20,0))
